...
TRAIN_FILENAMES = "/home/acb11913xp/prisma/filenames_list"
FS_DRIVER="prisma://localhost"
...
def get_shuffled_filenames(is_training, data_dir, num_epochs):
  """Return filenames for dataset."""
  if is_training:
    """create file with the shuffled filenames list."""
    training_fns = get_filenames(is_training, data_dir)
    filenames_list = shuffle_filenames.shuffle_filenames(training_fns, num_epochs)
